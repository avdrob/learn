...
void TestFunctionality(
  ...
  srv.UpdateDocumentBase(docs_input);
  {
    ...
    ostreams.push_back(move(queries_output));
  }
  srv.AddQueriesStream(queries_input, ostreams.back());

  // // this_thread::sleep_for(chrono::microseconds(1000));
  // const string result = ostreams.back().str();
...
int main() {
  ...
  // SearchServer srv;
  // srv.UpdateDocumentBase(cin);
  // srv.AddQueriesStream(cin, cout);
  // this_thread::sleep_for(chrono::microseconds(1000));
